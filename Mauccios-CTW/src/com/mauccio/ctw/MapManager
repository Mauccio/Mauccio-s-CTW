...
public final class MapManager {
  ...
  public void saveKit(Player player) throws IOException {
    ...
    c.save(new File("plugins/" + File.separator + "Mauccios CTW" + File.separator + "Kits", player.getUniqueId() + ".yml"));
  }
  
  public void saveGlobalKit(Player player) throws IOException {
    YamlConfiguration c = new YamlConfiguration();
    c.set("global-kit", player.getInventory().getContents());
    c.save(new File("plugins/" + File.separator + "Mauccios CTW" + File.separator + "globalkit.yml"));
  }
...
public ItemStack[] getPlayerKit(Player player) throws NullPointerException {
    YamlConfiguration c = YamlConfiguration.loadConfiguration(new File("plugins/" + File.separator + "LibelulaCTW-Reborn" + File.separator + "Kits", player.getUniqueId() + ".yml"));
  ...
  public ItemStack[] getGlobalKit() {
    YamlConfiguration c = YamlConfiguration.loadConfiguration(new File("plugins/" + File.separator + "LibelulaCTW-Reborn" + File.separator + "globalkit.yml"));
  ...
  public ItemStack[] getKitInvItem() {
	  YamlConfiguration c = YamlConfiguration.loadConfiguration(new File("plugins/" + File.separator + "LibelulaCTW-Reborn" + File.separator + "kitinv.yml"));
